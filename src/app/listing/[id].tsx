...
import listingsData from '@/src/assets/data/airbnb-listings.json';
import Animated, {
  SlideInDown,
  interpolate,
  useAnimatedRef,
      ...
      <Animated.ScrollView contentContainerStyle={{ paddingBottom: 100 }} ref={scrollRef} scrollEventThrottle={16}>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.rooms}>
            {listing.guests_included} guests · {listing.bedrooms} bedrooms · {listing.beds} bed · {listing.bathrooms}{' '}
            bathrooms
          </Text>
